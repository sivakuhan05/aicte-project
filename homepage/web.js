document.addEventListener('DOMContentLoaded', () => {
  const roles = {
    student: {
      ...
      loginHref: '../userpage/login.html',
      signupHref: '../userpage/signup.html'
    },
    organization: {
      tag: 'Organization',
      title: 'Organization Portal',
      description: 'Create events, manage your club or association, and track approvals.',
      loginHref: '../organiserpage/orglog.html',
      signupHref: '../organiserpage/orgsignin.html'
    },
    admin: {
      tag: 'Admin',
      title: 'Admin Portal',
      description: 'Approve accounts and events, review club activity, and manage the platform.',
      loginHref: '../adminpage/login.html',
      signupHref: '../adminpage/signup.html'
    }
  };
